...
def load_chunk_sizes():
    ...
    if not os.path.exists(video_folder + 'video_sizes.npy'):
        wget.download('https://www.dropbox.com/s/hg8k8qq366y3u0d/video_sizes.npy?dl=1',out=video_folder + 'video_sizes.npy')
...
def load_traces():
    ...
    if not os.path.exists(trace_folder):
        #wget.download('https://www.dropbox.com/s/xdlvykz9puhg5xd/cellular_traces.zip?dl=1',out=park.__path__[0] + '/envs/abr_sim/')
